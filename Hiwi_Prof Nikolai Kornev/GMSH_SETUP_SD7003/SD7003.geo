...
//+
Transfinite Curve {2, 15} = n_inlet Using Bump 0.095;
//+
Transfinite Line {3, -11, -10, -4, -12, -9} = n_vertical Using Progression 0.95;
//+
Transfinite Curve {5, 16} = n_airfoil_Upper Using Bump 0.011 ;
//+
Transfinite Curve {17, 6} = n_airfoil_lower Using Bump 0.005;
//+
Transfinite Curve {7,13, 8} = n_wake Using Progression 1.04;
